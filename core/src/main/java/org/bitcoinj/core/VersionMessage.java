...
public class VersionMessage extends Message {
    ...
    public static final String LIBRARY_SUBVER = "/"+CoinDefinition.coinName+":" + BITCOINJ_VERSION + "/";//"/bitcoinj:" + BITCOINJ_VERSION + "/";
    ...
    public boolean isBloomFilteringSupported() {
        //return clientVersion >= FilteredBlock.MIN_PROTOCOL_VERSION;
                return clientVersion >= CoinDefinition.MIN_PROTOCOL_VERSION && CoinDefinition.supportsBloomFiltering;
    }
