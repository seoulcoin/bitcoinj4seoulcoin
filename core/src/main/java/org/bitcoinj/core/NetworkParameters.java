...
public abstract class NetworkParameters implements Serializable {
     ...
     */
    public static final byte[] SATOSHI_KEY = Utils.HEX.decode(CoinDefinition.SATOSHI_KEY); //"04fc9702847840aaf195de8442ebecedf5b095cdbb9bc716bda9110971b28a49e0ead8564ff0db22209e0374782c093bb899692d524e9d6a6956e7c5ecbcd68284");
    ...
    public static final String ID_REGTEST = ID_TESTNET + "reg";//"org.bitcoin.regtest";
    /** Unit test network. */
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            t.addOutput(new TransactionOutput(n, t, /*FIFTY_COINS*/COIN.multiply(CoinDefinition.genesisBlockValue), scriptPubKeyBytes.toByteArray()));
        } catch (Exception e) {
            // Cannot happen.
     ...
     */
    public static final long MAX_COINS =  CoinDefinition.MAX_COINS;//21000000;

    /**
     * The maximum money to be generated
     */
    public static final Coin MAX_MONEY = COIN.multiply(CoinDefinition.MAX_COINS);//MAX_COINS);
